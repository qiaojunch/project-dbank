...
document.querySelector("form").addEventListener("submit", async function(event) {
    ...
    if (document.getElementById("withdrawal-amount").value.length != 0) {
        await _declarations_dbank__WEBPACK_IMPORTED_MODULE_1__.dbank.withdraw(outputAmount);
    }
...
async function update() {
    const currentValue = await _declarations_dbank__WEBPACK_IMPORTED_MODULE_1__.dbank.checkBalance();
